...
--define_symbol uuid128_to_str=0x0002441d
--define_symbol uuid_add_bluetooth_prefix=0x00024475
--define_symbol uuid_has_bluetooth_prefix=0x00024495
--define_symbol uxListRemove=0x000244b1
--define_symbol uxQueueMessagesWaiting=0x000244d9
--define_symbol uxQueueMessagesWaitingFromISR=0x00024501
--define_symbol uxQueueSpacesAvailable=0x0002451d
--define_symbol uxTaskGetStackHighWaterMark=0x00024549
--define_symbol uxTaskPriorityGet=0x00024569
--define_symbol uxTaskPriorityGetFromISR=0x00024585
--define_symbol vListInitialise=0x0002463f
--define_symbol vListInitialiseItem=0x00024655
--define_symbol vListInsert=0x0002465b
--define_symbol vListInsertEnd=0x0002468b
--define_symbol vPortEndScheduler=0x000246a5
--define_symbol vPortEnterCritical=0x000246d1
--define_symbol vPortExitCritical=0x00024715
--define_symbol vPortFree=0x00024749
--define_symbol vPortSuppressTicksAndSleep=0x000247dd
--define_symbol vPortValidateInterruptPriority=0x00024905
--define_symbol vQueueDelete=0x00024961
--define_symbol vQueueWaitForMessageRestricted=0x0002498d
--define_symbol vTaskDelay=0x000249d5
--define_symbol vTaskInternalSetTimeOutState=0x00024a21
--define_symbol vTaskMissedYield=0x00024a31
--define_symbol vTaskPlaceOnEventList=0x00024a3d
--define_symbol vTaskPlaceOnEventListRestricted=0x00024a75
--define_symbol vTaskPriorityDisinheritAfterTimeout=0x00024ab5
--define_symbol vTaskPrioritySet=0x00024b61
--define_symbol vTaskResume=0x00024c29
--define_symbol vTaskStartScheduler=0x00024cad
--define_symbol vTaskStepTick=0x00024d3d
--define_symbol vTaskSuspend=0x00024d6d
--define_symbol vTaskSuspendAll=0x00024e29
--define_symbol vTaskSwitchContext=0x00024e39
--define_symbol xPortStartScheduler=0x00024ee1
--define_symbol xQueueAddToSet=0x00024fa9
--define_symbol xQueueCreateCountingSemaphore=0x00024fcd
--define_symbol xQueueCreateCountingSemaphoreStatic=0x00025009
--define_symbol xQueueCreateMutex=0x0002504d
--define_symbol xQueueCreateMutexStatic=0x00025063
--define_symbol xQueueCreateSet=0x0002507d
--define_symbol xQueueGenericCreate=0x00025085
--define_symbol xQueueGenericCreateStatic=0x000250d1
--define_symbol xQueueGenericReset=0x00025139
--define_symbol xQueueGenericSend=0x000251c5
--define_symbol xQueueGenericSendFromISR=0x00025331
--define_symbol xQueueGiveFromISR=0x000253f1
--define_symbol xQueueGiveMutexRecursive=0x00025495
--define_symbol xQueueIsQueueEmptyFromISR=0x000254d5
--define_symbol xQueueIsQueueFullFromISR=0x000254f9
--define_symbol xQueuePeek=0x00025521
--define_symbol xQueuePeekFromISR=0x00025649
--define_symbol xQueueReceive=0x000256b5
--define_symbol xQueueReceiveFromISR=0x000257e1
--define_symbol xQueueRemoveFromSet=0x00025875
--define_symbol xQueueSelectFromSet=0x00025897
--define_symbol xQueueSelectFromSetFromISR=0x000258a9
--define_symbol xQueueSemaphoreTake=0x000258bd
--define_symbol xQueueTakeMutexRecursive=0x00025a29
--define_symbol xTaskCheckForTimeOut=0x00025a6d
--define_symbol xTaskCreate=0x00025add
--define_symbol xTaskCreateStatic=0x00025b39
--define_symbol xTaskGetCurrentTaskHandle=0x00025ba9
--define_symbol xTaskGetSchedulerState=0x00025bb5
--define_symbol xTaskGetTickCount=0x00025bd1
--define_symbol xTaskGetTickCountFromISR=0x00025bdd
--define_symbol xTaskIncrementTick=0x00025bed
--define_symbol xTaskPriorityDisinherit=0x00025cb9
--define_symbol xTaskPriorityInherit=0x00025d4d
--define_symbol xTaskRemoveFromEventList=0x00025de1
--define_symbol xTaskResumeAll=0x00025e61
--define_symbol xTaskResumeFromISR=0x00025f29
--define_symbol xTimerCreate=0x00025fb5
--define_symbol xTimerCreateStatic=0x00025fe9
--define_symbol xTimerCreateTimerTask=0x00026021
--define_symbol xTimerGenericCommand=0x0002608d
--define_symbol xTimerGetExpiryTime=0x000260fd
--define_symbol xTimerGetTimerDaemonTaskHandle=0x0002611d
